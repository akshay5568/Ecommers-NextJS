  ...
  return (
    <div className="w-[100%] h-screen text-center flex items-center justify-center">
      ...
      <form onSubmit={handleLogin}>
        <Input name="email" type="email" placeholder="Email" required className={'mb-3 mt-3'} />
        <Input name="password" type="password" placeholder="Password" required />
        <Button className={'mt-3 mb-3'} type="submit">Login</Button>
      </form>

      <hr />
      <button onClick={() => signIn("google", { callbackUrl: "/" })} className="hover:underline font-bold cursor-pointer">
        Sign in with Google
      </button>
